...
delta_f_activated = delta_f_activated/2;
delta_f_activated(1) = 0.1;
...
[r,rs,rd] = sarc2spindle(dataB,dataC,1,1,0.05,0.5,0.01); 
...
u = interp1(0:0.001:4,u,t); %upsample to higher precision

v_th = 0.6;   %threshold voltage for spike
tsim = t;
dt = 1e-4; %
